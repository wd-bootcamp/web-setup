...
```sh
zsh <(curl -s https://wd-bootcamp.github.io/web-curriculum/docs/web-setup/setup)
```

<details>
<summary>What does this do?</summary>

This command will download the [setup script](https://github.com/wd-bootcamp/web-setup/blob/main/setup) from GitHub and run it on your computer.
...
```sh
zsh <(curl -s https://wd-bootcamp.github.io/web-curriculum/docs/web-setup/setup-git)
```
